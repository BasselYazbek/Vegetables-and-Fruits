...
const Vegetables = ({ name, imagePath, price, onEdit, onDelete, isAdmin, onToggleStock, isOutOfStock, vegetablesMenu }) => {
...
const Vegetables = ({ name, description, imagePath, price, onEdit, onDelete, isAdmin, onToggleStock, isOutOfStock, vegetablesMenu }) => {
    const [isEditingPrice, setIsEditingPrice] = useState(false);
    const [newPrice, setNewPrice] = useState(price);
